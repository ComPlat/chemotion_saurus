...
This attribute indicates whether the layer is used in a workflow design process. It is only available in editable mode and applies exclusively to [Generic Elements](../elements) and [Generic Segments](../segments).

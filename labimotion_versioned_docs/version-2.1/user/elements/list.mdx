...
A Generic Element utilizes the same data model entity as other static entities like [samples](/docs/eln/ui/elements/samples) and [reactions](/docs/eln/ui/elements/reactions). Initially, these elements are hidden in the 'Tab Layout' and users must drag them into the visible area to access them via the element list tabs.
...
- Utilize the 'Tab Layout' to display or conceal the desired Generic elements.
  - Drag an element from the Invisible (gray background color) area to the Visible (white background color) area to make it visible.
  - Drag an element from the "visible" (white background color) area to the "invisible" (gray background color) area to make it hidden.

![Element List](/img/labimotion/user/elements/list/element-list.png)
...
![Element Tabs](/img/labimotion/user/elements/list/element-tabs.png)

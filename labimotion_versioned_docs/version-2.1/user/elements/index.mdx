...
Chemistry has many subdisciplines and characteristics. Therefore, it is difficult to define one model for all applications. That is why [LabIMotion](/docs/labimotion) provides Generic Elements. Domain experts define the attributes that fit their specific needs.
...
![Element Counter](/img/labimotion/user/elements/element-counter.png)

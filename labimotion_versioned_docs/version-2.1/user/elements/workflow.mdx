...
[LabIMotion](/docs/labimotion) assists scientists in creating customized modules tailored to their requirements. Within these modules, scientists can outline processes comprising a sequence of actions/steps aimed at achieving specific outcomes. Additionally, LabIMotion facilitates the construction of workflow logics using interactive diagrams.
...
![Workflow](/img/labimotion/user/elements/workflow/workflow.png)

...
<detail>
  <summary>Nota bene</summary>- DOI®, DOI.ORG®, and shortDOI® are trademarks of
  the International DOI Foundation. - When submitting to the repository, the
  submitter of a publication can choose between several CC licenses for the
  submitted work. As the result, the content of this repository database
  (including the submitted publication files) can be licensed under any one of
  the following:
  [CC0](https://creativecommons.org/share-your-work/public-domain/cc0/), [CC
  BY](https://creativecommons.org/licenses/by/4.0/) and [CC
  BY-SA](https://creativecommons.org/licenses/by-sa/4.0/). Please see
  [here](`link`) for more.
</detail>
## Imprint

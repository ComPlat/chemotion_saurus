...
There are differnt options to become familiar with Chemotion ELN and to request support. The training acticities for Chemotion are strongly supported by the team of NFDI4Chem.
...
(1) If you would like to report/request single issues, please post the issues to our github project: https://github.com/ComPlat/chemotion_ELN/issues. Please give as many details as you are able to give to facilitate the understanding of the issue. Preferably also images or screenshots. 

(2) If you have a list of issues/points of interest, please send a list of issues to nicole.jung[at]kit.edu.

(3) For all NFDI4chem members: please add your single issues to github (as in 1) and submit lists of issues to the contact person of your sub-discipline (see contact persons below). 

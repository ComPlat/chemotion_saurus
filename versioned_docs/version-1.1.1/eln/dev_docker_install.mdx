...
Make sure you have docker running. Create a folder where you want to keep Dockerfiles and shell scripts for dockerization and, in the terminal, clone the following [repository](https://github.com/ptrxyz/chemotion/tree/chemotion-cli/client-vscode-remote-container) to it:

```
git clone https://github.com/ptrxyz/chemotion.git
```
On the `chemotion-cli` branch, change into the `client-vscode-remote-container` folder:

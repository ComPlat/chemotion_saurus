...
git clone https://github.com/ptrxyz/chemotion.git
```
- Switch to `v1.0.3D01` branch:

```
git checkout v1.0.3D01
```

:::info
There was a pull request when this documentation was last updated and it is provided by this link: https://github.com/ptrxyz/chemotion/pull/19. Make sure that you have those fixes if you instlaa chemotion before it is merged.

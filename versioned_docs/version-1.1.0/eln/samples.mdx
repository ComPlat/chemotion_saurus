...
:::caution Recommendation 
You can find instructions on how to generate samples by drawing molecules in Ketcher editor [here](https://eln.chemotion.net/chemotionsaurus/docs/eln/ketcher), and you can learn about adding details about your sample [here](https://eln.chemotion.net/chemotionsaurus/docs/eln/details_modal#details-modal-for-samples). 
:::    

...
Text Templates is where you manage reusable text snippets for editors throughout the ELN.
...
Click **Text Templates** inside the <Btn mixed={[faCog]} color={"secondary"}/> toolbar settings popover from a text editor. It opens in the same tab. When you're done, hit **Back** to return to the editor — your toolbar picks up the changes straight away, no reload needed.
...
- **Global** — shared templates visible to everyone; you can edit them only if you have [Global Template Editor](../admin/user-management#global-text-template-editor-rights) rights

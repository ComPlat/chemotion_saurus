...
Given the variety of ontologies that may be required for different applications, we have provided a feature that allows system administrators to enable/disable ontology terms within the system. Kindly refer to the [Admin Interface > Load OLS Terms](../../../eln/admin/ontology) for further information.

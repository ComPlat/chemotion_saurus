...
<video controls>
  <source src={require("@site/static/img/eln/ui/elements/samples/mixtures/mixture_5.webm").default} />
</video>

Another example:

<video controls>
  <source src={require("@site/static/img/eln/ui/elements/samples/mixtures/mixture_6.webm").default} />
</video>

...
Users are provided with the flexibility to choose between exporting/importing individual chemical samples or multiple selected samples. This functionality is conveniently accessible through the Export/Import Menu toolbar icon ![Export Menu](./_media/inventory/action_bar_import_export.png). The export and import of chemical samples is currently supported in the xlsx and csv formats.

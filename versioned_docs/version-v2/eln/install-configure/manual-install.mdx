...
If you face problems, please let us know; we are there to support you. You may [contact us directly](https://chemotion.net/helpdesk) if you plan to install Chemotion or have problems installing/using it.

...
You can find additional applications in the **[LabIMotion Template Hub](https://www.chemotion-repository.net/home/genericHub)**, a platform designed to enhance resource sharing and streamline access to valuable templates contributed by researchers and professionals.
...
Discover the features of **[Chemotion Repository](/docs/repo)** and unlock the potential to publish your work efficiently.
...
:::info
If you need permission to access Designer features, encounter any issues, or have questions, feel free to reach out to us at [chemotion-labimotion](mailto:chemotion-labimotion@lists.kit.edu).
:::

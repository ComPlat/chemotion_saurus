...
The purpose of the Chemotion Converter (in short: ChemConverter) is to convert different file formats and types from [integrated devices](../../eln/devices) to a common and well known data type, namely e.g. jcamp .jdx or .json.
...
To finish your creation or save changes click on the "Create/Update profile" button or else everything will be lost.

...
Sometimes the key is provided together with the value, which makes it easier for the Reader to recognize the string as a Metadata, and in other cases, it has to be defined or assigned by a user with background and RegEx knowledge.

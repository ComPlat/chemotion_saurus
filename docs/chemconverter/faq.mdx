...
- <b>Answer:</b> If you are sure, that the reason is not the converter itself (because you tested it on a standalone version and it works), we need to add your file extension / type to our whitelist. Please let us know.
...
- <b>Workaround:</b> Just to have basic features for looking at the curves, an already more accomplished layout like CV, UV/VIS or NMR is recommended to be used. 
...
- <b>Long answer:</b> We encourage you to look at the [reader documentation page](/chemconverter/readers). Here you will also find a list of readers with advanced features.

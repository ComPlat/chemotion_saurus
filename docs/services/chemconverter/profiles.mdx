...
### <a name="c9d63af9"></a> Profile: Tensile test data from txt

Inspect Table 50kN; reference location: Fraunhofer IWS, with data conversion, without metadata extraction ;HighTemp

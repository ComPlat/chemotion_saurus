...
| Material testing         |             | Tensile Test high Temp             | Tensile test data from txt, data: +, metadata: - <br /> Inspect Table 50kN; ref location: Fraunhofer IWS, data: +, metadata: - ; <br /> HighTemp | Inspect Table 50kN | *.txt | Link |

...
When using a file from the inbox that comes from an integrated device, the user should use the ChemConverter-produced file (if a conversion is necessary / possible for this kind of file).

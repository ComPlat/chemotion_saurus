...
The file size restriction is set by the admin of the Chemotion ELN instance and can be adjusted to the user's needs.
...
and allows the analysis of data attached to a [sample](/docs/eln/ui/elements/samples) or [reaction](/docs/eln/ui/elements/reactions) in the Chemotion ELN.
...
The user interface of ChemSpectra is identical for different analytical methods,
...
![UI-ChemSpectra](/img/services/chemspectra/spectra_editor.png)
...
<video controls>
  <source src={require("@site/static/img/services/chemspectra/chemspectra-demo.webm").default} />
</video>
...
Tabs at the top-right of the ChemSpectra editor allow users to switch between the different spectra. Each spectrum behaves as expected, with the full set of tools available for that specific type.

<video controls>
  <source src={require("@site/static/img/services/chemspectra/multi-spectra-demo.webm").default} />
</video>

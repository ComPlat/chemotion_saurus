...
# Overview of Common Templates
  ...
  Global/Common templates are available to use with ketcher2. Common templates is a list of templates made available for all the users to use by Sytem Admin.

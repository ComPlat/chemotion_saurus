...
To use ChemLocalLink, the user must work with an [ELN](/docs/eln/ui) version that supports third-party applications.

:::info  
Available from ELN version 1.10
:::
...
![UI-OpenLocally](/img/services/chemlocallink/interaction/openlcl.png)

...
ChemLocalLink is a cross-platform desktop application designed to open all [ELN](../eln/ui) files locally, keeping them in one place for easier editing, opening, and uploading them back if needed.  

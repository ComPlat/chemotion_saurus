...
ChemLocalLink is a cross-platform desktop-based software, designed to handle opening all [ELN](/docs/eln/ui) files locally, keeping them in one place for easier editing, opening, and uploading them back if needed.  

...
Linux users interested in testing can contact the [developer](mailto:mekky@kit.edu).
:::

ChemLocalLink is a cross-platform desktop application designed to open all [ELN](/docs/eln/ui) files locally, keeping them in one place for easier editing, opening, and uploading them back if needed.  
...
- **File Handling**: Allows users to download Chemotion-related files, modify them, and then upload them back
...
![UI-ChemLocalLink](/img/services/chemlocallink/img1.png)

Please go to the different sub-pages under ChemLocalLink to get insight into how to install and use this application.

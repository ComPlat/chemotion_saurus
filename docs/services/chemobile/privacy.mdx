...
- any information on the location of the place where the image is taken.

Nevertheless, the motif of the picture depends on the user and the recording of additional information with the image depends on the device on which the app is used.

...
- For box plots, groups can be defined for the color of the box border and the fill of the box (See plot b and c).
- Other plot types only support the color attribute (See plot c).
- **Legend Titles**: Set titles for fill and color legends to improve legibility.
...
Choose between Box plot, Scatter plot, and Line plot, and click **Create Plot** to generate:

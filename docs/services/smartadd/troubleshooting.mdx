...
2. Create [samples](../../eln/ui/elements/samples) and [reactions](../../eln/ui/elements/reactions) using the buttons in the right panel
...
- [Chemscanner](../chemscanner) ZIPs (with `export.json`) create samples and reactions automatically

...
- Include the [sample](../../eln/ui/elements/samples) or compound identifier
...
For a [reaction](../../eln/ui/elements/reactions) with multiple samples:
...
**Import from [Chemscanner](../chemscanner) to create collection structure:**

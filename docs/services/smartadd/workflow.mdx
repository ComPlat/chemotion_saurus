...
Upload the analytical data files to SmartAdd. These files will be stored in the input list, ready for the user to assign to [samples](../../eln/ui/elements/samples) and analyses.
...
Use this to automatically create samples and [reactions](../../eln/ui/elements/reactions) from [Chemscanner](../chemscanner) data:

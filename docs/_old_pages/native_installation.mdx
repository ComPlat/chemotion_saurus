...
![architecture_ELN](/img/_old_pages/native_installation/architecture_ELN_base.svg)
...
![architecture_ELN_dist](/img/_old_pages/native_installation/architecture_ELN_dist.svg)
...
Configuration files for the application are in the _config_ directory.

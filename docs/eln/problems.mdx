...
## Known issues
For known issues and the work on the known issues, please see also our github page: 
https://github.com/ComPlat/chemotion_ELN/issues 

## ELN is not responding
In individual cases it can happen that the ELN does not react to an action. If you have the feeling that your application is not giving any feedback, please reload the page by pressing **F5**. If the problem persists, please contact us using the email address given in the contact information or call us.

## Actions are not avtivated
Check whether you are in your work collection. The **All Collection** is not intended for changes.

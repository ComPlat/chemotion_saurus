...
:::info
Please take care that you communicate name conventions to all users of the ELN: 
...
<b>Config ELN’s data collector:</b>
The ELN's data collector has to be configured to collect emails with NMR data attachments. 

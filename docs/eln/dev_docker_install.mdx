...
Instead, depencencies and configurations regarding the ELN installation are limited to the container (or more specifically, the underlying image, more on that later).
...
On your Windows machine, [open a `WSL 2` terminal](https://docs.microsoft.com/en-us/windows/wsl/wsl-config#ways-to-run-wsl) and proceed with the setup as outlined [here](DevDocker#Setup).

...
Please use Chrome as browser in the actual version.
:::

Other browsers such as Firefox or Internet Explorer only allow limited functionality in some areas of application.

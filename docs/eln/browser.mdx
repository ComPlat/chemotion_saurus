...
slug: browser
---
For the use of the Chemotion systems Chemotion ELN and Repository, Chrome is recommended. Firefox can be used for most of the actions, but special functions in e.g. ChemSpectra behave differently.

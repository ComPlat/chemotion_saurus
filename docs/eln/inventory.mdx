...
:::info
For using the inventory collection with differnt users that can move items into or create items in the inventory, please update the system to version 2.1.0.
:::

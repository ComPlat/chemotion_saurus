...
This declares the proxy network as external i.e. it is allowed to talk to the host's network. However, you also need to create such a network explicitly by running the following command in your shell:

...
- Use the [test version](/helpdesk) to check the latest versions of Chemotion ELN and Repository.
- Use an [installed version](../install_configure) for routine use in operations.
  :::

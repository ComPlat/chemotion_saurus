...
While we strive to support all instances of Chemotion, the documentation only deals actively with fresh installations and upgrades for ELN versions released in past 12 months. For anything before that, and **particularly for installations that run natively** (i.e. without docker), please get in touch with the [helpdesk](https://chemotion.net/helpdesk) for more personalized support.

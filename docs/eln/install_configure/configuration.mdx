...
### Enable ketcher 2 Editor

After you have Chemotion running on your machine, here are some further steps to have Ketcher2 running. Follow them to ensure a smooth setup.
...
#### 2. Add Ketcher2 Files to public/editor/ketcher2/ using script
  ...
  Run the installation script (Choose one script based on release required):

```bash
bin/chem-ket2-install.sh  -s epam/ketcher@v2.21.0
```

building from release at v2.22.0-rc.9

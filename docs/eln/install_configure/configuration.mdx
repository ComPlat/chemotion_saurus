...
From Chemotion ELN v2 onwards, [EPAM Ketcher](https://lifescience.opensource.epam.com/ketcher/) will be the default structure editor. Do not forget to enable it as a feature from the ELN adminstration interface.

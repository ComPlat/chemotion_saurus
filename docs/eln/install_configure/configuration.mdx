...
For Chemotion ELN v2.x epam/ketcher will be automatically installed to a compatible version. Do not forget to enable it as a feature from the ELN adminstration interface.

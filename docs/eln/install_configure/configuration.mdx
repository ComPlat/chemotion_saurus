...
production:
  :editors:
    :chemdraw:
      :label: "ChemDrawJS"
      :license: "license file" # license file of ChemDraw
      :extJs: ["ChemDraw js file"] # ChemDraw JS file
    :ketcher2:
      :label: "Ketcher 2"

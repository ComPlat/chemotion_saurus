...
production:
  ...
  :nmriumwrapper:
    :url: "https://nmrium.nmrxiv.org/releases/v0.4.0/"
```

Please note ELN versions 1.5.0 to 1.7.1 only support nmriumwrapper version 0.1, and therefore for these ELNs, the `nmriumwrapper.url` value should be `https://nmrium.nmrxiv.org/releases/v0.1.0/`. To be able to access these URLs successfully, you must register with the hosting service. Please see [here](https://github.com/NFDI4Chem/nmrium-react-wrapper#public-instance) for more details.

...
:::caution Important Announcement
...
| ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| [v1.5.3](https://github.com/ComPlat/chemotion_ELN/releases/tag/v1.5.3) | [eln-1.5.3](https://raw.githubusercontent.com/ptrxyz/chemotion/72eb3b95caa7ce304b9bd80ae7c288645a9823d8/docker-compose.yml) | [0.2.x](https://github.com/Chemotion/ChemCLI/releases/tag/0.2.4)                                                                         |
| [v1.3.1](https://github.com/ComPlat/chemotion_ELN/releases/tag/v1.3.1) | [eln-1.3.1p220712](https://github.com/ptrxyz/chemotion/blob/cb906ce8d37e0a173ae66b3696a9f039f540eace/docker-compose.yml)    | [0.1.x](https://github.com/Chemotion/ChemCLI/releases/tag/0.1.6-alpha), [0.2.x](https://github.com/Chemotion/ChemCLI/releases/tag/0.2.4) |
...
- Have another feature in mind: [Open an issue](https://github.com/Chemotion/ChemCLI/issues) or contact our [helpdesk](/helpdesk)!

...
| NMR Benchtop | Magritek | 60 Proton Ultra | Spinsolve | Automatic | Powershell script | |Benchtop NMR | Magritek | Spinsolve | Automatic | Powershell script | [link to details](https://wiki.scc.kit.edu/lsdf/index.php/LSDF_Online_Storage:_SMB_/_CIFS#Using_SMB.2FCIFS_on_Windows) |

...
| NMR Benchtop | Magritek | 60 Proton Ultra | Spinsolve | Automatic | Powershell script | |Benchtop NMR | Magritek | Spinsolve | Automatic | Powershell script | [link](https://www.chemotion.net/chemotionsaurus/docs/eln/devices/devices_nmr_magritek) |

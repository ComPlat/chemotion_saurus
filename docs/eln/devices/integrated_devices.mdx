...
|---|:---:|---|:---:|---|:---:|---|
| DSC | Netzsch | DSC 214 | NETZSCH Messung | Automatic | exe | link |
| DSC | TA Instruments | DSC2500 | TRIOS | Automatic | exe | link |
| FTIR | Bruker | Alpha II | Opus 8.5 | Automatic | exe | link |
...
| NMR | Bruker | Avance 400 | TopSpin or IconNMR | Automatic | email | link |
| NMR Benchtop | Magritek | 60 Proton Ultra | Spinsolve | Automatic | Powershell script | |Benchtop NMR | Magritek | Spinsolve | Automatic | Powershell script | <a href="https://www.chemotion.net/chemotionsaurus/docs/eln/devices/devices_nmr_magritek"> |
...
| SEC | Agilent / PSS | 1200 HPLC | PSS winGPC | Automatic | exe | link |
| SEC | Tosoh / PSS | Tosoh EcoSEC | PSS WinGPC | Automatic | exe | link |
| TGA | TA Instruments | TGA5500 | TRIOS | Automatic | exe | link |
| UV-VIS | Horiba | Duetta | EzSpec | Automatic | exe | link |

[link](https://www.chemotion.net/chemotionsaurus/docs/eln/devices/devices_nmr_magritek)

...
(analytical) devices to an Chemotion ELN. The given analytical methods are chosen
...
To be able to transfer data and assign data to a users Chemotion ELN-account, users have to follow strict rules regarding the labels/names of measurements.
...
If the filename contains an elements short label or name, it can be automatically or manually transferred to this elements from the inbox ([Details](../ui/inbox.mdx#moving-files-to-elements-into-the-analyses-section)).

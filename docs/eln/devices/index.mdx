...
<b>Figure 1:</b> Overview of the three procedures to integrate research data from
...
<b>Figure 2:</b> Data collection via the MailCollector routine implemented exemplarily
...
<b>Figure 3:</b> Data collection via DataCollectors (FileCollector and FolderCollector)

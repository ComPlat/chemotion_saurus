...
**IconNMR Configurations:** Data transfer via mail client (data is sent as email
attachment) from IconNMR to the Chemotion ELN can be set up when the Chemotion ELN’s
...
**Config Chemotion ELN’s data collector:** The Chemotion ELN's data collector
has to be configured to collect emails with NMR data attachments.

:::note[Links]

[see the email-attachment-collector settings page](../../install_configure/configuration#email-attachment-collection)

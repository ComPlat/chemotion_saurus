...
**TopSpin Configurations:** A shared network storage location needs to be made
...
<b>IconNMR Configurations:</b> Data transfer via mail client (data is sent as email
...
<b>Config Chemotion ELN’s data collector:</b> The Chemotion ELN's data collector

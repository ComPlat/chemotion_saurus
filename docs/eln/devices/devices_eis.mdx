...
Users will have access to the EIS PC via the Chemotion ELN. The EIS PC and the Chemotion ELN must be linked to the same
...
- As an admin of Chemotion ELN: As an admin of Chemotion ELN, we have to create a device instance corresponding to EIS

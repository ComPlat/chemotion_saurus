---
title: Bruker OPUS FT-IR *.dpt
---

This guideline explains the integration process of the IR device into the Chemotion ELN. This procedure
...
For the IR device integration, the Chemotion team decided to configure both these features.

...
id: devices_dsc
slug: devices_dsc
title: Low Temperature DSC Device
---

In this guideline, we have explained the integration process of the Low Temperature DSC device into the Chemotion
ELN. This procedure enables remote access to the PC connected to the device, which runs the software, DSC 214 and also
the transfer of the experiment data to the Chemotion ELN’s inbox.
...
- Software Name: DSC 214 (Version: 8.0.3)
...
Users will have access to the DSC PC via the Chemotion ELN. The DSC PC and the Chemotion ELN must be linked to the same
...
- As an admin of Chemotion ELN: As an admin of Chemotion ELN, we have to create a device instance corresponding to DSC

---
title: Agilent PSS WinGPC SEC/GPC
---

This guideline explains the integration process of the SEC-THF and SEC-DMAC devices into the Chemotion
...
For the SEC device integration, the Chemotion team decided to configure both these features.

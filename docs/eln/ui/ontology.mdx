...
Given the variety of ontologies that may be required for different applications, we have provided a feature that allows system administrators to enable/disable ontology terminology within the system. Kindly refer to the [Admin Interface > Load OLS Terms](/docs/eln/admin/ontology.mdx) for further information.

...
The admin has to enable this function. It can either be added to the Chemotion ELN interfaces of all users, or made available to specific users. However any functionality will not be visible unless it is activated from the [Admin panel](/docs/eln/admin).

...
The tif and tiff formats are converted to png format before annotation to be able to display them in the browser. The original image is preserved and remains unchanged.
...
- When the editor is started for the first time, the user is asked whether they want to save the settings and the history locally.
...
- **In Research Plan (body)**
  ![](/img/eln/ui/images/20230306_image_annotation_research_body.png)

- **In Research Plan (attachments)**
  ![](/img/eln/ui/images/20230306_image_annotation_research_attachment.png)

- **In a Dataset**:
  ![](/img/eln/ui/images/20230306_image_annotation_dataset.png)

## Editor

The integrated editor is [svgedit](https://github.com/SVG-Edit/svgedit). The editor can be divided into 4 different areas.

![Sharing](/img/eln/ui/images/20230306_image_annotation_editor.png)

...
New elements are created with the green `CREATE` button to the right of the toolbar. Clicking it opens a menu with the options **Create Sample**, **Create Reaction**, **Create Wellplate**, **Create Screen** and **Create Research Plan**. It does not matter which element list is selected, as long as you are in the right collection — choose any of these options and the corresponding element is created.

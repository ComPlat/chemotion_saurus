...
The user can filter a selected collection or even the **All** collection with the filtering bar <img src={require('@site/static/img/eln/ui/toolbar/filter.png').default} alt={"Filter bar"} />.

...
Exporting data from the Chemotion ELN can be done using the icon ![Export Menu](/img/eln/ui/toolbar/action_bar_import_export.png); importing data does not use this icon and is described separately below.

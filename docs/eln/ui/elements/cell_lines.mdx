...
### Tabular form
<img
  src={require("@site/static/img/user_interface/elements/cell_lines/20231204_cell_line_table_form.png").default}
...
<img
  src={require("@site/static/img/user_interface/elements/cell_lines/20231204_cell_line_info_button.png").default}
  alt={"Cell lines in table form"}
/>
2. Button to create a sample of the current cell line concept. All properties of the current concept are filled in automatically.
...
#### Properties tab
<img
  src={require("@site/static/img/user_interface/elements/cell_lines/20231204_cell_line_details_1.png").default}
...
<img
  src={require("@site/static/img/user_interface/elements/cell_lines/20231204_cell_line_details_details_references.png").default}
  alt={"Item specific properties"}
/>

...
Wellplates can be created through different options via the dropdown menu in the <img src={require('@site/static/img/action_bar_create_wellpalte.png').default} alt={"create wellplate"} height={"7%"} width={"7%"}/> in the <b>Action Bar</b>. Find the Action Bar in the structure of the [Action Bar](../../ui#action-bar).

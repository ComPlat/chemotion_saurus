...
Currently, [samples](.) are treated as single molecules without categorization. However, the Chemotion team plans to classify samples into
...
2. **Drawing in Ketcher:** Draw the mixture using [Ketcher](../../ketcher).
...
- Use mixtures in [reaction](../reactions) schemes

...
This feature is available from ELN version 3 onwards. If you are interested, please feel free to test it in our [demo ELN](https://demo.chemotion.ibcs.kit.edu/).
...
Currently, [samples](/docs/eln/ui/elements/samples) are treated as single molecules without categorization. However, the Chemotion team plans to classify samples into
...
- **Advanced Calculations**
  ...
  - Recalculates volume and amount dynamically.
...
!["Sample type selection"](/img/eln/ui/elements/samples/mixtures/mixture_1.png)
!["Sample type selection options"](/img/eln/ui/elements/samples/mixtures/mixture_2.png)

### Sample Element Updates

Here is an overview of the default Sample interface:

!["Default sample"](/img/eln/ui/elements/samples/mixtures/mixture_3.png)

Once the Mixtures option is selected, the primary focus shifts to the **Components Table**:

!["Sample with mixture"](/img/eln/ui/elements/samples/mixtures/mixture_4.png)
...
2. **Drawing in Ketcher:** Draw the mixture using [Ketcher](/docs/eln/ui/ketcher) 1 or 2.
...
!["Demo 1"](/img/eln/ui/elements/samples/mixtures/mixture_5.gif)

Another example:

!["Demo 2"](/img/eln/ui/elements/samples/mixtures/mixture_6.gif)
...
- If the combined volume of all components is less than the specified total volume, users are expected to add solvent(s)
...
for planning the reaction's components; it does not have an impact on the component table.
...
!["Demo 2"](/img/eln/ui/elements/samples/mixtures/mixture_7.png)
...
- Use mixtures in [reaction](/docs/eln/ui/elements/reactions) schemes
- Import/export of mixture samples, including components

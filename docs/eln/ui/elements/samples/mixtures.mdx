...
<video controls>
  <source src={require("@site/static/img/eln/ui/elements/samples/mixtures/create_mixture.webm").default} />
</video>

Another example:

<video controls>
  <source src={require("@site/static/img/eln/ui/elements/samples/mixtures/create_mixture_2.webm").default} />
</video>
...
!["Demo 2"](/img/eln/ui/elements/samples/mixtures/mixture_solvents_table.png)

...
!["Shapes and label control buttons in the Ketcher toolbar"](/img/hierarchical_sample_type/polymer_options.png)
...
!["Shape with label text applied"](/img/hierarchical_sample_type/polymer_template_example.png)

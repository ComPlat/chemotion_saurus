...
<img
  src={require("@site/static/img/samples_list.png").default}
  alt={"Samples List"}
/>
...
To export sample data, navigate to the toolbar and click the dropdown export menu <img src={require('@site/static/img/dropdown_menu.png').default} width={"50px"} alt={"dropdown menu"}/>. A panel **Select Data to Export** will open up when **Export samples from selection** in the dropdown export menu is clicked.

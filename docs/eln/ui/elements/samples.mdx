...
Samples are required for almost every operation within the Chemotion ELN, and their maintenance and thoughtful use is key to using the Chemotion ELN successfuly.

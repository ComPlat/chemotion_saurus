...
:::caution Recommendation
You can find instructions on how to generate samples by drawing molecules in Ketcher editor [here](../ketcher), and you can learn about adding details on your sample [here](../details_modal#details-modal-for-samples).
:::
...
The Chemotion ELN supports importing data from Excel files with appropriate formatting and also importing data from sd files (sdf). In both cases, a sample is produced for each identified molecular structure after the import process. The samples generated in this way are available to the user in the target collection. Details on the import of samples and data or requirements of the files to be loaded are described in the page [Toolbar functions](../toolbar#import-samples-to-a-certain-eln-collection).

...
More details about populating a reaction with samples can be found in the [Details modal for reactions](../details#details-modal-for-reactions) chapter.
...
the reactions list is reduced and the [details modal](../details#details-modal-for-reactions) appears.
...
By clicking on the reaction list, a [details modal for reactions](../details#details-modal-for-reactions) opens on the right side.

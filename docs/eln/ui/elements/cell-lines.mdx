...
Cell lines are represented and treated analogously to other elements ([Sample](/docs/eln/ui/elements/samples), [Reaction](/docs/eln/ui/elements/reactions), ... )

### Tabular form

<img
  src={
    require("@site/static/img/eln/ui/elements/cell_lines/20231204_cell_line_table_form.png")
      .default
  }
...
<img
  src={
    require("@site/static/img/eln/ui/elements/cell_lines/20231204_cell_line_info_button.png")
      .default
  }
  alt={"Cell lines in table form"}
/>
...
<img
  src={
    require("@site/static/img/eln/ui/elements/cell_lines/20231204_cell_line_details_1.png")
      .default
  }
...
<img
  src={
    require("@site/static/img/eln/ui/elements/cell_lines/20231204_cell_line_details_2.png")
      .default
  }
...
src={require("@site/static/img/eln/ui/elements/cell_lines/20231204_cell_line_details_button.png").default}
alt={"Item specific properties"}
/> button.
...
<img
  src={
    require("@site/static/img/eln/ui/elements/cell_lines/20231204_cell_line_details_details_references.png")
      .default
  }
  alt={"Item specific properties"}
/>
...
1. By selecting a [collection](/docs/eln/ui/collections), a new cell line can be created in this collection using the <img
   src={require("@site/static/img/eln/ui/elements/cell_lines/20231204_cell_line_create_button.png").default}
   alt={"Item specific properties"}
...
<img
  src={
    require("@site/static/img/eln/ui/elements/cell_lines/20230206_cell_line_search.png")
      .default
  }
  alt={"Item specific properties"}
/>

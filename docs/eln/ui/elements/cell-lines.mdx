...
Cell lines are represented and treated analogously to other elements ([Sample](samples), [Reaction](reactions), ... )
...
1. By selecting a [collection](../collections), a new cell line can be created in this collection using the <img

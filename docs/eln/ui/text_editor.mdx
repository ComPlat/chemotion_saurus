...
The **MT dropdown** in the toolbar can show predefined templates as well as your personal templates and new global templates. Open the toolbar settings menu and click [Text Templates](./text_templates) to manage the templates that appear there.

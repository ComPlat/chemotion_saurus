---
title: Creating Inventory for a Group
sidebar_label: Inventory
sidebar_position: 8
---

:::info
For using the inventory collection with different users that can move items into or create items in the inventory, please update the system to version 1.1.1 or later ones
:::

...
This is the simple import method. For the enhanced, validated import, see [Importing Data with Column Mapping and Validation](#importing-data-with-column-mapping-and-validation) below.
...
<video controls>
  <source src={require("@site/static/img/common/import_samples.webm").default} />
</video>
...
<video controls>
  <source src={require("@site/static/img/eln/ui/import/sample_enhanced_import_1.webm").default} />
</video>
...
<video controls>
  <source src={require("@site/static/img/eln/ui/import/sample_import_columns_mapping.webm").default} />
</video>
...
<video controls>
  <source src={require("@site/static/img/eln/ui/import/enhance_sample_import_data_validation.webm").default} />
</video>

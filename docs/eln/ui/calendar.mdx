...
Dragging an existing event around the calendar allows the user to easily change the event time, and the duration can be changed by dragging the edges of an event.

...
The calendar can be used to organize a variety of events for users, including events for shared [collections](/docs/eln/ui/collections), and individual elements within the Chemotion ELN.

## Accessing the calendar

The calendar can be accessed in 2 ways:

1. The `Calendar` button in the [top bar](/docs/eln/ui#top-bar)
2. Within an element's header

![Calendar Buttons](/img/eln/ui/calendar/calendar_buttons.png)

Element specific events can be created for the following elements:

- [Samples](/docs/eln/ui/elements/samples)
- [Reactions](/docs/eln/ui/elements/reactions)
- Screens
- Research Plans
...
![Main Calendar](/img/eln/ui/calendar/calendar.png)

An element specific calendar shows its own events / all user created events.
![Element Calendar (Sample)](/img/eln/ui/calendar/sample_calendar.png)
![Element Calendar (Sample) with user events toggled](/img/eln/ui/calendar/sample_calendar_with_user_events.png)
...
![Event Modal](/img/eln/ui/calendar/event_modal.png)
...
<video controls>
  <source src={require("@site/static/img/eln/ui/calendar/modify_event_time_duration.webm").default} />
</video>

...
The main calendar initially shows all user created events.
![Main Calendar](/img/calendar/calendar.png)

An element specific calendar initially shows all element specific events, and all user events can be shown also.
...
Dragging the edges of existing events allows the user to modify the event duration.

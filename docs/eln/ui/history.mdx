...
If you can't see the tab, look [here](./view#adjust-the-tabs-in-the-detail-modal)
how to display hidden tabs.
In this tab you can see a version for each change: ![versions](/img/eln/ui/history/versions.png)

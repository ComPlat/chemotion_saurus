...
Installation with root or sudi user
:::
...
The link to the installation scipts for the different machines is missing. On the end of the page are important information -> link possible?

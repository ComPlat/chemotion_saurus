...
When splitting the tasks on several machines make sure you meet the above [harware requirement](#hardware-requirement) and ensure that the 
following is accessible to any web-app or worker-app instance

...
### Markdown 
The main content of Docusaurus is stored in Markdown files. There are `.md` or `.mdx` file endings possible. `.mdx` is recommended, because it also supports the usage of React. For detailed description look into the [usage chapter](use_docusaurus). 
...
Detailed informations can be found in the [Docusaurus documentation about assets](https://docusaurus.io/docs/static-assets) and [versioning](https://docusaurus.io/docs/versioning#use-absolute-import-within-the-docs) and in the [usage chapter](use_docusaurus).

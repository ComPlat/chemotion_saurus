...
import { faSortDown, faPen, faTimes, faArrowRight, faMinusSquare, faShareAlt, faSortUp, faDownload, faWindowClose, faEraser, faArrowsAlt, faFileAlt, faPercentage} from '@fortawesome/free-solid-svg-icons' 

...
[Download XLSX Template here](https://github.com/ComPlat/chemotion_saurus/blob/master/static/files/template%20_sample_import.xlsx). Please don't change the header of the template file. 
:::

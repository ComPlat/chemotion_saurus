...
import { faSortDown, faPen, faTimes, faArrowRight, faMinusSquare} from '@fortawesome/free-solid-svg-icons' 
...
To share a collection, press <Btn mixed={[faShare]} color={"info"}/>, this will open the following window. <img src={"/chemotionsaurus/img/sharing.png"} alt={"Sharing"}/> 

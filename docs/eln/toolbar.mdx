...
import { faSortDown, faPen, faTimes, faArrowRight} from '@fortawesome/free-solid-svg-icons' 
...
The abovementioned action could be done by selecting the chosen elements, and pressing <Btn mixed={[faArrowRight,faSortDown]} color={"success"}/>. 

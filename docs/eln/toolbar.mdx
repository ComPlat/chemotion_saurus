...
import { faSortDown, faPen, faArrowRight, faMinusSquare, faShareAlt, faSortUp, faDownload, faTimes, faEraser, faArrowsAlt, faFileAlt, faPercentage, faPLus} from '@fortawesome/free-solid-svg-icons' 

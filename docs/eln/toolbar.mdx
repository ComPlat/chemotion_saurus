...
Please don't change the header of the template file. 
:::
...
:::caution Recommendation
Please add either molfile or Smiles-Code to the import template. The import process will fail of both is entered.
:::

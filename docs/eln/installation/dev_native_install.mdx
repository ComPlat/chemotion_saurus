...
:::danger Caution
Please note that the native installation is not supported any longer. If you face any issues during the installation, we recommend that you switch to Docker installation.
:::

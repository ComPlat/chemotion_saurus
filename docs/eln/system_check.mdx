...
1H NMR example (.zip): <p><DownloadBtn files={['/chemotionsaurus/static/files/SVS-957 F1_10.zip']}  text={"Download zip file for 1H NMR here "}/></p>
1H NMR example (.dx): <p><DownloadBtn files={['/chemotionsaurus/static/files/SVS-957 F1_10.dx']}  text={"Download zip file for 1H NMR here "}/></p>

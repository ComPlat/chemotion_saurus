...
This step is only required if you have been granted permission to use the Search CAS (<Btn mixed={[faSearch, "Search CAS"]} color={"secondary"} />) feature (ELN 1.3+ versions) or the Scifinder tab feature (prior to ELN 1.0.0).

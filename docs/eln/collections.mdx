...
![Collection View](/img/first-collection-sub.gif)
...
use the button <button className={"button button--sm button--success"} style={{padding:"0.5rem"}}><FontAwesomeIcon icon={faPlus} size="lg"/>  <FontAwesomeIcon icon={faShareAlt} size="lg"/></button> to initiate a corresponding assignment and define the assignment of rights. 

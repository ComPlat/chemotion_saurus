...
Synchronized collections can be created in the collection management. In **My Collections** management, in the chosen collection to be synchronized, use the button <button className={"button button--sm button--danger"} style={{padding:"0.5rem"}}> 

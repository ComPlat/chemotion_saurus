...
| <Btn mixed={[faShareAlt]} color={"secondary"}/> | Your own collections are listed in the collection bar. Collections that you have shared with other researchers (**My shared collections**) or that have been shared with you (<b>Shared with me</b>) are also listed. Collections can also be created that are permanently accessible by several users (**Synchronized collections**). |

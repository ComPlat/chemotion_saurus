...
- Download the Chemotion URL Handler via the link on chemotion navigation bar or using this [link](https://drive.google.com/file/d/18xV1WELet-qIPUgSItb5QNa_Jc-xxvrz/view).![Code Scanner Button](/img/locally_editable_attachment/url_handler_download.png). 

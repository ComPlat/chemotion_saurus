...
You can check [GitHub Actions](https://github.com/ComPlat/chemotion_saurus/actions/workflows/build.yml), to see if your changes are succesfully merged in the web page. More information about GitHub Actions (in general and for the ELN) are in the [testing chapter](testing_code).
...
<img src={"/img/mgmt_level_btn.png"} width={"20px"} alt={"Management Level Button"}/>
``` 
There should be no /static in the image path.

...
You can check [GitHub Actions](https://github.com/ComPlat/chemotion_saurus/actions/workflows/build.yml), to see if your changes are succesfully merged in the web page. More information about GitHub Actions (in general and for the Chemotion ELN) are in the [testing chapter](development/testing_code).
...
- short links for insert a new page (= create a new file on GitHub):
    - [Create New Chemotion ELN Documentation Page](https://github.com/ComPlat/chemotion_saurus/new/master/docs/eln)
...
1. in ```sideba Chemotion ELN.js```: Add the new version to the ```Versions``` category.
...
For example: you are planning a new version 0.10, that is already the current version of the code. Then you probably have a version 0.8 and a current version with the label 0.9 (but not with a versioned folder 0.9) in docusaurus. Now you create a version 0.9 through the npm command. Your current version gets 0.10 and is stored in ```docs Chemotion ELN``` and you will have one more versioned folders: 0.9 and 0.8.
...
1. If versioning is enabled, you have to use two different TOCs for each part of the documenation, instead of one TOC. Use  [**sidebarELN.js**](https://github.com/ComPlat/chemotion_saurus/edit/master/sidebarELN.js) for the Chemotion ELN part and [**sidebarsREPO.js**](https://github.com/ComPlat/chemotion_saurus/edit/master/sidebarsREPO.js) for the Repository part instead of [**sidebars.js**](https://github.com/ComPlat/chemotion_saurus/edit/master/sidebars.js) for all parts. Before that, the different TOCs needs probably been updated.

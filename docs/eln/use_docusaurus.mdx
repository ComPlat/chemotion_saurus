...
```
## TOC
The TOC on the left of every documentation page must be manually updated via [**sidebars.js**](https://github.com/ComPlat/chemotion_saurus/edit/master/sidebars.js) on GitHub. If you have inserted a new page or want to change the order, change it there.

...
1. If versioning is enabled, you have to use two different TOCs for each part of the documenation, instead of one TOC. Use  [**sidebar Chemotion ELN.js**](https://github.com/ComPlat/chemotion_saurus/edit/master/sidebar Chemotion ELN.js) for the Chemotion ELN part and [**sidebarsREPO.js**](https://github.com/ComPlat/chemotion_saurus/edit/master/sidebarsREPO.js) for the Repository part instead of [**sidebars.js**](https://github.com/ComPlat/chemotion_saurus/edit/master/sidebars.js) for all parts. Before that, the different TOCs needs probably been updated.

...
When all the required attributes are provided, press <Btn mixed={["Create", faFloppyO]} color={"primary"}/> to create the element, or cancel the process with <Btn mixed={["Cancel"]} color={"warning"}/>. 

...
## Generic elements 
ELN contains five original elements which are the samples, reactions, wellplates, screens, and research plans. However, other generic elements can be added as needed by the administration.

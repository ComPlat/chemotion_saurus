...
<div align="center">
  <img src="../../static/img/generic_segment_new.png">
</div>
...
|---|---|
| Segment Label | the name used to display on the UI |
| Description | used to describe the segment, like its purpose, usage...etc. |
| Assign to Element | define which element this segment belongs to |

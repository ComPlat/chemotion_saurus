...
Chemotion ELN provides users with an easy way to search in CAS SciFinder<sup>n</sup>. To enable this feature, the necessary information needs to be configured in the `scfinder_n.yml` file.

...
ChemCLI, short for Chemotion CLI, is a tool that helps administrators manage Chemotion ELN on a machine. The goal is to make [installation](/docs/eln/install-configure) and maintenance of (multiple instances of) Chemotion as easy as possible.

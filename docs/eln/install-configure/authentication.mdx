...
The Chemotion team also offers third-party authentication options, including Shibboleth, OIDC (Open ID Connect), ORCID, GitHub, and NFDI AAI. To configure these options, visit the [Chemotion Administration](../admin) page. On the left side, under '[UI Features](../admin/features)', find the function labeled 'User Provider'. Click on the yellow 'Edit JSON' button to access the configuration settings.

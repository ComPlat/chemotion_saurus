...
For detailed setup instructions for ChemDraw, please refer to [Structure editor](../install_configure/configuration#structure-editor){:target="_blank" rel="noopener noreferrer"}.

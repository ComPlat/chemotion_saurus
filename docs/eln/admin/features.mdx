...
This feature allows administrators to enable or disable the `FastInput` creation of [samples](../ui/elements/samples) using CAS numbers or SMILES strings.
...
This feature allows administrators to configure [third-party authentication methods](../install-configure/authentication) for user login, such as OpenID Connect (OIDC) and Shibboleth.

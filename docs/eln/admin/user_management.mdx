...
![adminui-usermanagement](/img/admin_ui/admin_ui-user_management.png)
...
![adminui-usermanagement-createuser](/img/admin_ui/admin_ui-user_management-newuser.png)

Add the information for the new user account or upload a csv file containing the accounts' information.

![adminui-usermanagement-createuser-modal](/img/admin_ui/admin_ui-user_management-newuser-mod.png)
...
![adminui-usermanagement-editing-modal](/img/admin_ui/admin_ui-user_management-editing.png)

![adminui-usermanagement-editing-modal](/img/admin_ui/admin_ui-user_management-deleting-mod.png)

## (De-)activating vs (Un-)locking an account

![adminui-usermanagement-lock-activate](/img/admin_ui/admin_ui-user_management-lock-activate.png)
...
![adminui-usermanagement-default-user-space](/img/admin_ui/admin_ui-default_user_space.png)

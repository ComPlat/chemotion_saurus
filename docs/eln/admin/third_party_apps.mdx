...
> [Biostats](https://github.com/ComPlat/Biostats) is an example Application that has been integrated with the ELN, for more see [ Biostats](../../services/third_party_apps/biostats) documentation.

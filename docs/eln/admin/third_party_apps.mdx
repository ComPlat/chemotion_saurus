...
> [OpenStats](https://github.com/ComPlat/OpenStats) is an example Application that has been integrated with the ELN, for more see [OpenStats](../../services/third_party_apps/OpenStats) documentation.

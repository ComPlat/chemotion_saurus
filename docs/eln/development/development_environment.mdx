...
:::info Clean Docker
When you're having trouble setting up the ELN's Docker environment, make sure that
you're working with a clean Docker system: <https://docs.docker.com/config/pruning/>.
:::

...
During rebasing you might have to [resolve merge conflicts](TODO_link_to_resource).
...
## Pull requests from your feature branch

With pull requests (in the following referred to as PR),
the team can review features, and eventually merge them into the default branch.

...
##### self-hosted runners
After installation (or restart of the system?#TODO) you have to start the service of the runner:
- cd actions-runner
- (sudo ./svc.sh install)
- sudo ./svc.sh start

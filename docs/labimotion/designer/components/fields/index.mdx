...
import fieldMove from "@site/static/img/labimotion/field-move.png";
import {
  FigCaption,
  SubTitle,
  YouTubeFrame,
...
:::note
If you get an empty list, please check with your administrator if the ontology service is correctly configured. (See [Allowing access to Terminology Service](/labimotion/preparation#allowing-access-to-terminology-service))
:::

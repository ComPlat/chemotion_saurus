...
As a [Designer](/docs/labimotion/design-principles#-designer-role), one can sync collectively contributed templates from the Template Hub to their instance. This allows users to seamlessly work with the templates and publish their work step-by-step. See [Template Sync. & Publish](/docs/labimotion/template-sync-and-publish).

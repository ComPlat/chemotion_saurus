...
Not all Generic Elements are designed with a workflow; whether Generic Elements are designed with a workflow depends on the template created by the [Designer](/labimotion/design-principles#-designer-role).

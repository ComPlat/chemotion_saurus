...
import mapperConcept from "@site/static/img/labimotion/user/datasets/metadata-mapper/metadata-mapper.png";
...
1. The corresponding dataset template exists and is active in the user's system.
...
<div align="center">
  <img
    src={mapperConcept}
    alt="LabIMotion - Generic Dataset: Metadata Auto Mapper"
  />

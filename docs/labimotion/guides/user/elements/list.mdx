...
Mirroring the Element List Approach. Refer to [List](/docs/eln/ui/lists).

Mirroring the Element Grouping Approach. Refer to [Grouping](/docs/eln/ui/elements/grouping).

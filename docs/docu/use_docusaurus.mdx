---
id: use_docusaurus
title: Contribute to the Docusaurus
sidebar_label: Contribute to the Docusaurus
slug: use_docusaurus
---
...
## Editing
To ensure consistent style and naming throughout the documentation, please make sure to have a look at our [styleguide](styleguide_docusaurus).
...
In order to fork the repository you only need to click the green `Fork this repository` button.
...
For advanced contributions to the Docusaurus, you can clone the repository and directly push your changes (follow the instructions in the [set up chapter](Set%20Up#development))

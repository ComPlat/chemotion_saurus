...
- Collection DOIs: Collection DOIs refer to a whole collection of data, including reactions, samples and analysis data. They are used to decribed a study with just one DOI. 
...
Explanation how to access DOIs for reactions and samples and how to add them manually: 

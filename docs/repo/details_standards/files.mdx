...
| mass   | UHR-TOF Bruker Daltonik maXis II | .xy            | Yes        | file needs adaptation before upload![^6.3]        |
...
[^6.3] According to Table "mass spectrometry", the file needs to be opened and a new line on the top of the file has to be inserted: line1:

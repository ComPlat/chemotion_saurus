...
Example: <sup>1</sup>H NMR (500 MHz, MeOD-d<sub>4</sub> [3.31 ppm], ppm) δ = 13.23 (bs, 2H, CO2H), 8.24 (d, 1H, <i>J</i> = 1.5 Hz, CH), 8.17 (dd, 1H, <i>J</i> = 8.0 Hz, 1.5 Hz, CH), 8.05 (m, 2H, CH), 7.81 (d, 1H, <i>J</i> = 8.0 Hz, CH), 7.63 (m, 2H, CH), 7.49 (m, 2H, CH). Missing signal (1H, OH) due to H/D exchange in MeOD-d<sub>4</sub>.

...
Example: <sup>1</sup>H NMR (500 MHz, MeOD-d<sub>4</sub> [3.31 ppm], ppm) δ = 13.23 (bs, 2H, CO2H), 8.24 (d, 1H, <i>J</i> = 1.5 Hz, CH), 8.17 (dd, 1H, <i>J</i> = 8.0 Hz, 1.5 Hz, CH), 8.05 (m, 2H, CH), 7.81 (d, 1H, <i>J</i> = 8.0 Hz, CH), 7.63 (m, 2H, CH), 7.49 (m, 2H, CH). Missing signal (1H, OH) due to H/D exchange in MeOD-d<sup>4</sup>.
...
- wrong: <sup>1</sup>H NMR (400 MHz, CDCl<sub>3</sub> [7.27 ppm], ppm) δ = (...), 1.11 (dd, <i>J</i> = 11.1 Hz, <i>J</i> = 2.2 Hz, 2 H), (...); <sub>13</sub>C NMR (100 MHz, CDCl<sub>3</sub> [77.0 ppm], ppm) δ = (...), 111.1 (2 C), (...).
- right: <sup>1</sup>H NMR (400 MHz, CDCl<sub>3</sub> [7.27 ppm], ppm) δ = (...), 1.11 (dd, <i>J</i> = 11.1 Hz, <i>J</i> = 2.2 Hz, 2H); <sup>13</sup>C NMR (100 MHz, CDCl<sub>3</sub>3 [77.0 ppm], ppm) δ = (...), 111.1 (2C), (...).
...
- <b>
  ...
  of all isomers:
  <br />
  Example: <sup>1</sup>H NMR (500 MHz, MeOD-d<sub>4</sub> [3.31 ppm], ppm) δ = 13.23 (bs, 0.4H, CO2H-isomer1), 12.98 (bs, 0.6H, CO2H-isomer2), 8.24 (d, 0.6H, <i>J</i> = 1.5 Hz, CH-isomer2), 8.21 (d, 0.4H, <i>J</i> = 1.5 Hz, CH-isomer1), 3.30 (s, 3H, CH3-isomer1+-isomer2) etc.
...
- wrong: <b><sup>1</sup>H NMR</b> (300 MHz, CDCl<sub>3</sub> [7.27 ppm], ppm) δ = (...), 2.27 – 2.22 (m, 2H, C<i>H</i>2), (...).
- right: <b><sup>1</sup>H NMR</b> (300 MHz, CDCl<sub>3</sub> [7.27 ppm], ppm) δ = (...), 2.27–2.22 (m, 2H, C<i>H</i>2), (...).

...
- wrong: <sup>1</sup>H NMR (300 MHz, CDCl<sub>3</sub> [7.27 ppm], ppm) δ = (...), 2.27 – 2.22 (m, 2H, C<i>H</i>2), (...).
- right: <sup>1</sup>H NMR (300 MHz, CDCl<sub>3</sub> [7.27 ppm], ppm) δ = (...), 2.27–2.22 (m, 2H, C<i>H</i>2), (...).

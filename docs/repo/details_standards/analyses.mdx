...
Example: <sup>1</sup>H NMR (500 MHz, MeOD-d4, ppm) δ = 13.23 (bs, 2H, CO2H), 8.24 (d, 1H, <i>J</i> = 1.5 Hz, CH), 8.17 (dd, 1H, <i>J</i> = 8.0 Hz, 1.5 Hz, CH), 8.05 (m, 2H, CH), 7.81 (d, 1H, <i>J</i> = 8.0 Hz, CH), 7.63 (m, 2H, CH), 7.49 (m, 2H, CH). Missing signal (1H, OH) due to H/D exchange in MeOD-d4.
...
- <b>
  ...
  of all isomers:
  <br />
  Example: <sup>1</sup>H NMR (500 MHz, MeOD-d4, ppm) δ = 13.23 (bs, 0.4H, CO2H-isomer1), 12.98 (bs, 0.6H, CO2H-isomer2), 8.24 (d, 0.6H, <i>J</i> = 1.5

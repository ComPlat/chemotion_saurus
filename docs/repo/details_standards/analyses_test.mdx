...
<b>(3) Example with solvent ratio where CDCl<sub>3</sub> is used as a reference:</b><br /> 
...
<sup>1</sup>H NMR (400 MHz, MeOD-d<sub>4</sub>, 25 °C): δ [ppm] = 7.28 (dd, <i>J</i> = 1.6, <i>J</i> = 7.7 Hz, 1H), 7.14 (ddd, <sup>3</sup><i>J</i> = 8.2, <sup>3</sup><i>J</i><sub>H,F</sub> = 7.3, <sup>4</sup><i>J</i> = 1.6 Hz, 1H), 6.74–6.66 (m, 2H), 4.94 (s, 2H), 4.04 (br.s, 2H), 2.12 (s, 3H). Missing signal (1H, OH) due to H/D exchange in MeOD. Impurities: 10% impurities due to the formation of the cis-isomer during the measurement of the sample. <br /> 
...
<sup>1</sup>H NMR (250 MHz, CDCl<sub>3</sub>, ppm) δ = 7.08 (dd, <i>J</i> = 7.6, 1.2 Hz, 1H, NHCC<i>H</i>), 6.97 (ps.td, <i>J</i> = 7.6, 1.2 Hz, 1H, CHCC<i>H</i>), 6.63 (ps.td, <i>J</i> = 7.6, 1.2 Hz, 1H, NHCCHC<i>H</i>), 6.48 (dd, <i>J</i> = 7.6, 1.2 Hz, 1H, CHCCHC<i>H</i>), 3.85 (bs, 1H, N<i>H</i>), 3.40–3.22 (m, 2H, NHC<i>H</i><sub>2</sub>), 3.02–2.84 (m, 1H, C<i>H</i>CH<sub>3</sub>), 2.07–1.92 (m, 1H, CH<sub>a</sub>), 1.76–1.61 (m, 1H, CH<sub>b</sub>), 1.30 (d, <i>J</i> = 7.0 Hz, 3H, CH<sub>3</sub>). <br /> 
<b>(11) Example for assignment according to option 3:</b><br /> 
<sup>1</sup>H NMR (250 MHz, CDCl<sub>3</sub>, ppm) δ = 7.08 (dd, <i>J</i> = 7.6, 1.2 Hz, 1H, H<sub>ar</sub>), 6.97 (ps.td, <i>J</i> = 7.6, 1.2 Hz, 1H, H<sub>ar</sub>), 6.63 (ps.td, <i>J</i> = 7.6, 1.2 Hz, 1H, H<sub>ar</sub>), 6.48 (dd, <i>J</i> = 7.6, 1.2 Hz, 1H, H<sub>ar</sub>), 3.85 (bs, 1H, N<i>H</i>), 3.40–3.22 (m, 2H, H-2), 3.02–2.84 (m, 1H, H-4), 2.07–1.92 (m, 1H, H<sub>a</sub>-3), 1.76–1.61 (m, 1H, H<sub>b</sub>-3), 1.30 (d, <i>J</i> = 7.0 Hz, 3H, CH<sub>3</sub>). 
...
### Examples for desired formatting:
<b>(1) Standard example:</b><br /> 
<sup>13</sup>C NMR (100 MHz, CDCl<sub>3</sub>, 25 °C): δ [ppm] = (...), 129.5, 126.7 (2C), (...).
...
- Give the amount of carbons if there is more than one carbon to be assigned to one signal (**example No 1**).
...
## Inline notation for <sup>19</sup>F NMR, <sup>31</sup>P NMR spectroscopy data
...
## Inline notation for Mass spectrometry data 
...
## Inline notation for IR spectroscopy data
...
## Inline notation for (P)XRD = powder X-ray diffraction 

PXRD (Cu Kα1, 0.15406 nm, xxx °C), 2θ [°] (d [nm]): 5.2 (1.68), 10.1 (0.83)

## Inline notation for Cyclic voltammetry data (CV)

CV (1 mM Cpd, 1 mM Fc in MeCN, vs RefE = Ag/AgNO3, 100 mV/s): E1/2, meas (DeltaEp) = -0.373 V (85 mV) [[Cu(TMGqu)2]+/2+], 0.060 V (80 mV) [Fc/Fc+]. 

CV (1mM Cpd in MeCN, vs Fc/Fc+, 100 mV/s): E1/2,calc (DeltaEp) = -0.433 V (85 mV) [[Cu(TMGqu)2]+/2+].


## Inline notation for X-ray = Single X-ray diffraction 


## Inline notation for UV-Vis data and fluorescence data

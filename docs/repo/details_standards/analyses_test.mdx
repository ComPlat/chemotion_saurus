...
<sup>1</sup>H NMR (250 MHz, CDCl<sub>3</sub>, ppm) δ = 7.08 (dd, <i>J</i> = 7.6, 1.2 Hz, 1H, H-5), 6.97 (pstd, <i>J</i> = 7.6, 1.2 Hz, 1H, H-7), 6.63 (pstd, <i>J</i> = 7.6, 1.2 Hz, 1H, H-6), 6.48 (dd, <i>J</i> = 7.6, 1.2 Hz, 1H, H-8), 3.85 (bs, 1H, N<i>H</i>), 3.40–3.22 (m, 2H), 3.02–2.84 (m, 1H), 2.07–1.92 (m, 1H), 1.76–1.61 (m, 1H), 1.30 (d, <i>J</i> = 7.0 Hz, 3H, CH<sub>3</sub>).
(10)  Example for assignment according to option 2: <br /> 

(11)  Example for assignment according to option 3: <br /> 
<sup>1</sup>H NMR (250 MHz, CDCl<sub>3</sub>, ppm) δ = 7.08 (dd, <i>J</i> = 7.6, 1.2 Hz, 1H, H<sub>ar</sub>), 6.97 (pstd, <i>J</i> = 7.6, 1.2 Hz, 1H, H<sub>ar</sub>), 6.63 (pstd, <i>J</i> = 7.6, 1.2 Hz, 1H, H<sub>ar</sub>), 6.48 (dd, <i>J</i> = 7.6, 1.2 Hz, 1H, H<sub>ar</sub>), 3.85 (bs, 1H, N<i>H</i>), 3.40–3.22 (m, 2H), 3.02–2.84 (m, 1H), 2.07–1.92 (m, 1H), 1.76–1.61 (m, 1H), 1.30 (d, <i>J</i> = 7.0 Hz, 3H, CH<sub>3</sub>). 

...
<sup>1</sup>H NMR (250 MHz, CDCl<sub>3</sub>, ppm) δ = 7.08 (dd, <i>J</i> = 7.6, 1.2 Hz, 1H, NHCC<i>H</i>), 6.97 (ps.td, <i>J</i> = 7.6, 1.2 Hz, 1H, CHCC<i>H</i>), 6.63 (ps.td, <i>J</i> = 7.6, 1.2 Hz, 1H, NHCCHC<i>H</i>), 6.48 (dd, <i>J</i> = 7.6, 1.2 Hz, 1H, CHCCHC<i>H</i>), 3.85 (bs, 1H, N<i>H</i>), 3.40–3.22 (m, 2H, NHC<i>H</i>2), 3.02–2.84 (m, 1H, C<i>H</i>CH<sub>3</sub>), 2.07–1.92 (m, 1H, CH<sub>a</sub>), 1.76–1.61 (m, 1H, CH<sub>b</sub>), 1.30 (d, <i>J</i> = 7.0 Hz, 3H, CH<sub>3</sub>). <br /> 

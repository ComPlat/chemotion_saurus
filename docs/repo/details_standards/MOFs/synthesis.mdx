...
## general description 
type: text
description: the general description depends on the type of Synthesis. It explains how the information on how the singel steps of preparation, conduction and workup are combined.  

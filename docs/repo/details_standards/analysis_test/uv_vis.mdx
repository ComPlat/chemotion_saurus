...
UV-VIS (abs, CH<sub>3</sub>OH, 10 mM, 20 °C); λmax [nm] (log ε, M<sup>-1</sup>cm<sup>-1</sup>) = xxx (a.aa) [sh], yyy (b.bb) [sh].<br />

Example for analysis of qualitative UV-Vis: <br />
UV-VIS (abs, CH<sub>3</sub>OH, 10 mM, 20 °C); λmax [nm] = xxx [sh], yyy [sh].<br />

Explanation:
xxx, yyy -> λmax in nm <br />

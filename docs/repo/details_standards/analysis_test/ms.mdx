...
- MS (ESI+, CH<sub>2</sub>Cl<sub>2</sub>) m/z (%): 391 (41) [M+H]<sup>+</sup>, 282 (31), 281 (18), 280 (100), 260 (11), 254 (10), 223 (11), 221 (48), 109 (10).
- MS (ESI-, MeCN) m/z (%): 163 (55) [M-H]<sup>-</sup>, 132 (15), 119 (100), 56 (78).
...
Examples for Organic chemistry
  In case you find the HRMS for [M]<sup>+</sup> please make sure you calculate the theoretical mass for the charged molecule: ([M-e<sup>-</sup>])<sup>+</sup>.

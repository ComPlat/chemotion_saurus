...
**Explanation:**<br /> 
Metadata<br /> 
solvent = mobile phase of the SEC instrument<br />
standard = polymer standard used for the calibration of the instrument and analyzing the measured sample<br />

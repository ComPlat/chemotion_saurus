...
If the compound contains phosphorus, the analysis set should contain <sup>31</sup>P NMR data. If the compound contains Fluorine atoms, the analysis set should contain <sup>19</sup>F NMR data. <sup>31</sup>P NMR data should be given with the same information and formatting as described in the data and metadatasection of <sup>1</sup>H NMR data. 
Differences are: 
- Signals should be reported to the nearest 0.1 ppm.

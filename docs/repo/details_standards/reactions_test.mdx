...
- Please ensure that the description of the reaction is as comprehensive as possible. You should provide descriptions of the experiments in enough detail so that a skilled researcher is able to repeat them. This means that each step of the work needs to be described sufficiently with all relevat details. 
...
Exception: for very long or hardly undertandable chemical names, please add the compound in the form of the sum formula in combination with the type of the compound.
...
The yield of a product of a reaction is given for pure products. The yield of a reaction should be given in weight, mmol/mol and percentage in parentheses after the compound name (or its equivalent). The informqtion in parentheses is separated by a comma. 

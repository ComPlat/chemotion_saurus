...
To publish data (disclose data to the public), you have to select data with the selection of the reaction or the molecule the data is assigned to. Select the molecule/reaction in the area “My BD” and use the collections “My data” or "Chemotion ELN gate”.

...
<video controls height={"100%"} width={"100%"}>
  <source
    src={require("@site/static/img/docs/repo/settings_preperation/collaborates_with_orcid.webm").default}
  />
</video>
...
<video controls height={"100%"} width={"100%"}>
  <source
    src={require("@site/static/img/docs/repo/settings_preperation/collaborates_with_name.webm").default}
  />
</video>

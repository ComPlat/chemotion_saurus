...
[3.3] Excel and CSV: some standard versions are supported (see list below) and described in the section ChemConverter- for others, please contact us.
...
[4.2] Excel and CSV: some standard versions are supported (see list below) and described in the section ChemConverter- for others, please contact us.
...
[5.2] Excel, CSV, Text: some standard versions are supported (see list below) and described in the section ChemConverter- for others, please contact us.

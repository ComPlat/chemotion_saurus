...
| NMR data          | file type   |required | explanation                                               |
| ----------------- | ---------   |:------: | --------------------------------------------------------- |
| 1D                | **zip**     |Yes      | Original data need to be provided                         |
|                   | jcamp       |Yes      | Is created automatically from ZIP                         |
|                   | jcamp(edit) |depends  | if automatically generated jcamp is of low quality        |
|                   | image       |Yes      | Is created automatically from ZIP                         |
|                   | nmrium      |No       | Desired if available                                      |

...
Incorporate your group leader into the workflow to allow them to review the submission before it is published. **By default, your group lead(s) will be selected as Additional Reviewers.** It is strongly recommended to add the group leader to ensure they can confirm that the data submission has been discussed and is approved.

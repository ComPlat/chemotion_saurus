...
Please note that the group leader needs to be added as collaborator in your account settings **"My Collaboration"**. Please see instructions here: [Add your collaborators](../settings-preparation/index.mdx#add-your-collaborators) and [Assing Group Lead](../settings-preparation/index.mdx#assign-group-lead)

...
The group leader receives an email and notification which means that a submission needs a revie of data of the group lead. Please review the items that require reviewing and confirmation.
...
Group leaders have acceess to the list of submissions available for review. Goup leaders see only those items to which they are assigned. Please select the one you wish to assess and choose an appropriate action:

...
you can choose one of the licenses CC0, CCBY, CCBY-SA or you can publish your data as public domain data "no license". Please select carefully and in accordance with the rules of your institution or group leader. Further hints can be found here: 

...
The OAI-PMH service exposes metadata stored in the [Chemotion Repository](/docs/repo) using the Open Archives Initiative Protocol for Metadata Harvesting (OAI-PMH).
...
A number of parameters can be used by harvesters to restrict harvest requests to certain portions of the metadata. They are:
...
- A user wants to request records in the oai_dc metadata format, between 2022-08-01T14:15:00Z and 2022-09-01T14:20:00Z.
...
- A user wants to request records in the oai_datacite metadata format, between 2022-08-01T14:15:00Z and 2022-09-01T14:20:00Z.
...
- A user uses the wrong verb in the OAI-PMH request

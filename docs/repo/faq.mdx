...
- **Answer:** Users with registration: 163. To access the data, no registration is necessary. The access to data is not tracked.

#### How many datasets are currently hosted by the repository?

- **Answer:** Information on the data availability is given at the landing page of the repository, e.g. 710 published reactions (+ 1293 under embargo or in reviewing status [date: 13.05.2021])

...
To publish data (disclose data to the public), you have to select data with the selection of the reaction or the molecule the data is assigned to. Select the molecule/reaction in the area “My BD” and use the collections “My data” or “ELN gate”.
...
(6) If you want to publish with embargo, please check the [embargo page](./2020-08-31-move-change-and-release-an-embargo.md) for further details.

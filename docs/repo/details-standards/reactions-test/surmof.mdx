...
Please read the guidelines that are given on the top-level [reactions](/docs/repo/details-standards/reactions) page. The basic concepts described there need to be applied for MOF reactions as well.

:::

Chemotion repository requires the addition of Metal Organic Frameworks (MOFs) in a standardized manner. To describe the synthesis of metal organic frameworks adequately, please consider the following sections **"MOF samples"**, **"MOF synthesis"**, **"SURMOF synthesis"** at this page and refer to characterization standards on [Analyses](../analysis-test) .
...
For a SURMOF drawing, please use [ketcher-rails](/docs/eln/ui/ketcher) as a molecule editor. Other molecule editors than ketcher rails lack the necessary function to add surfaces to the drawing.

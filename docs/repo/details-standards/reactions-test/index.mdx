...
- Please ensure that no abbreviations are used that need further explanations. A list of common abbreviations is given in the section "abbreviations" of this documentation. If you need to add abbreviations, please define them in "additional information for publication and purification". For common abbreviations, please see section [Abbreviations](abbreviations)
...
Please give all necessary details of the molecules/[samples](/docs/eln/ui/elements/samples) used in the reaction, this includes with respect to the sample
...
:::warning[Change in sample required]
...
Information on the purity of a product need to be added in the sample entity of the repository. A purity of 90% corresponds to the value of 0.9 in the field concentration of a sample.

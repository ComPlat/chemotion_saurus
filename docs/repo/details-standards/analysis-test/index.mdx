...
-- **analyses** -> each measurement type should be added with a new analysis section. Whenever another ontology term can be assigned, the user needs another analysis type to describe the data <br />

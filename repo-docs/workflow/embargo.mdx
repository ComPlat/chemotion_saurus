...
The embargo overview displays all embargo bundles currently in the repository. By selecting `Embargoed` in the main navigation bar of the repository, the overview is shown. You can check the status of your own submissions, while for reviewers, the status of all embargoes will be revealed.

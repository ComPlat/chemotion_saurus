...
This guide explains how to add, view, and manage funding information for [Reactions](/docs/eln/ui/elements/reactions), [Samples](/docs/eln/ui/elements/samples), and [Embargoed](workflow/embargo) data in the [Chemotion Repository](.).

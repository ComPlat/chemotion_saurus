...
so you can tell at a glance which hits have a physical sample behind them without opening each record —
see [Finding Data](search#reading-a-result). The compounds themselves can be browsed and filtered in the
[Molecule Archive](search#molecule-archive).

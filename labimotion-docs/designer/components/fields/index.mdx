...
:::note
If the list is empty, please check with the administrator whether the ontology service is correctly configured. (See [Allowing access to Terminology Service](../../../preparation#allowing-access-to-terminology-service))
:::
